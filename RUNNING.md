...
- **Node.js**: >= 20.0.0
- **pnpm**: >= 10.0.0
- **Docker & Docker Swarm**: Required for both development and production (enabled via `docker swarm init`).
...
3. **Configure Environment Variables**:
   ...
   cp .env.example .env
   ```
   _Note: For local development, the default values in `.env.example` are pre-configured to work with the Docker Stack setup._
...
See [Infrastructure Setup](docs/backend/11-infrastructure-setup.md) for detailed configuration and initial setup steps.
...
_Tip: Use `pnpm db:studio` to inspect your PostgreSQL data._
...
Historical changes and development sessions are documented in [docs/logs/](docs/logs/).

| Log                                                                | Description                        |
| ------------------------------------------------------------------ | ---------------------------------- |
| [2026-04-14](docs/logs/2026-04-14-electron-skill-desktop-build.md) | Electron skill & Desktop app setup |
